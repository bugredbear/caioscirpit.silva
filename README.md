...
while wait() do
    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"]:GetChildren()) do
        pcall(function()
            if v.Name == ("CurvedRing") or v.Name == ("DaSilvashHit") or v.Name == ("SwordDaSilvash") or v.Name == ("DaSilvashTail") or v.Name == ("Sounds") then
                v:Destroy()
            end
        end)
    end
...
local Window = OrionLib:MakeWindow({Name = "DaSilva Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "DaSilva Hub"})
...
W:AddLabel("[+] DaSilva Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "DaSilva Hub(Noitification)",
